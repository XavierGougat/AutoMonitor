<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" action="<?php echo site_url('Visitor/updatePassword')?>" method="post">
            ...
            <div class="form-group m-b-20">
                <div class="col-xs-6">
                    <p>
                        ...
                        <a href="<?php echo site_url('Visitor/Login');?>" class="btn btn-md btn-danger">Cancel <i class="fa fa-undo"></i></a>
                    </p>
                </div>
            </div>
        </form>
