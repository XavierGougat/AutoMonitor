<div class="row">
    <div class="col-md-12">
        <p>You will received an email to <?php echo $emailCrypted;?> with a verification code.<p>
        <p>Please enter below the code you received to confirm that you are the account owner.</p>
        <form action="<?php echo site_url('Visitor/confirmVerificationCode')?>" method="post">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <a href="<?php echo site_url('Visitor/Login');?>" class="btn btn-md btn-danger"><i class="fa fa-undo"></i></a>
                </div>
            </div>
        </form>
    </div>
